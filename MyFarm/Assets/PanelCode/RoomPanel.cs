...
public class RoomPanel : TTUIPage
{
    private List<Transform> prefabs = new List<Transform>();
    private Button closeBtn;
    private Button startBtn;
    public RoomPanel() : base(UIType.Normal, UIMode.DoNothing, UICollider.None)
    {
        uiPath = "UIPrefab/RoomPanel";
    }
    #region 生命周期
    /// <summary> 初始化 </summary>
    ...
    public void OnCloseBack(ProtocolBase protocol)
    {
        ...
        if (ret == 0)
        {
            ...
            TTUIPage.ShowPage<TipPanel>("退出成功");
        ...
        {
            TTUIPage.ShowPage<TipPanel>("退出失败");
    ...
    public void OnStartBack(ProtocolBase protocol)
    {
        ...
        if (ret != 0)
        {
            TTUIPage.ShowPage<TipPanel>("开始游戏失败！两队至少都需要一名玩家，只有队长可以开始战斗！!");
        }
